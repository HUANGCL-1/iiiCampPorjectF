					...
					<div class="col-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<input type="submit" value="新增" class="btn btn-success float-right"  onclick="location.href='http://localhost:8080/HibernatePJ/AdminLTE-3.0.5/admin.meber.addExample.jsp'">
									<thead>
										<tr>
											<th>id</th>
											<th>帳號</th>
